...
* Une fonction définie à l'intérieur d'une autre porte avec elle le *contexte* dans lequel elle a été créée,
...
__ http://jsbin.com/zifogo/12/edit?html,js,output
...
* Créez une horloge digitale qui rafraîchit son affichage automatiquement.
  ...
  et de la fonction
  `setTimeout <http://devdocs.io/dom/windoworworkerglobalscope/settimeout>`_.
